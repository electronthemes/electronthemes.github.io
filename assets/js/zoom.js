    ...
    return (
        ...
        function t(e) {
                        ...
                        if (p && -1 === v.indexOf(p)) t(L)
                            ...
                            if (
                                ...
                                ;(E.template = document.createElement('div')),
                                    E.template.appendChild(
                                        u.content.cloneNode(!0)
                                    ),
                            ...
                            if (
                                ...
                                E.original.classList.add(
                                    'medium-zoom-image--hidden'
                                ),
                                E.zoomed.classList.add(
                                    'medium-zoom-image--opened'
                                ),
                                E.zoomed.addEventListener('click', h),
                                E.zoomed.addEventListener(
                                    'transitionend',
                                    function e() {
                                        ;(z = !1),
                                            E.zoomed.removeEventListener(
                                                'transitionend',
                                                e
                                            ),
                                            E.original.dispatchEvent(
                                ...
                                ;(E.zoomedHd = E.zoomed.cloneNode()),
                                    ...
                                    (E.zoomedHd.src = E.zoomed.getAttribute(
                                        'data-zoom-src'
                                    )),
                                ...
                                ;(E.zoomedHd = E.zoomed.cloneNode()),
                                    E.zoomedHd.removeAttribute('sizes')
                                var f = E.zoomedHd.addEventListener(
                                    'load',
                                    function() {
                                        E.zoomedHd.removeEventListener(
                                            'load',
                                            f
                                        ),
                                            E.zoomedHd.classList.add(
            ...
            document.addEventListener('click', function(e) {
                var t = e.target
                t !== w ? -1 !== v.indexOf(t) && d({ target: t }) : h()
            }),
                ...
                update: function() {
                    ...
                    return (
                        ...
                        v.forEach(function(e) {
                            e.dispatchEvent(
                                x('medium-zoom:update', { detail: { zoom: L } })
                            )
                        }),
                        L
                    )
